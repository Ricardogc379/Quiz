...
public class SQLDao extends SQLiteOpenHelper {
    ...
    private static final String DB_CREATE_TABLE_QUESTAO =
            ...
            + QUESTAO_PERGUNTA + " TEXT NOT NULL, "
            + QUESTAO_RESPOSTA1 +" TEXT NOT NULL, "
            + QUESTAO_RESPOSTA2 + " TEXT NOT NULL, "
            + QUESTAO_RESPOSTA3 + " TEXT NOT NULL, "
            + QUESTAO_RESPOSTA4 +" TEXT NOT NULL, "
            + QUESTAO_CORRETA + " INTEGER NOT NULL, "
